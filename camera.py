...
from keras.layers import Dense, Dropout, Flatten,BatchNormalization,ReLU,Softmax
...
model.load_weights('face_emotions_weights.h5')

cv2.ocl.setUseOpenCL(False)

emotion_dict = {0:"Angry",1:"Fearful",2:"Happy",3:"Neutral",4:"Sad",5:"Surprised"}
music_dist={0:"songs/angry.csv",1:"songs/fear.csv",2:"songs/happy.csv",3:"songs/neutral.csv",4:"songs/sad.csv",5:"songs/surprised.csv"}
global last_frame1                                    
